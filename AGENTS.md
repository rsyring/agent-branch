...
# IMPORTANT: adding/updating Readme

Whenever we change something about how the app setup works, if it would impact another
developer's ability to run the app, we need to add or update the readme docs so they can
easily get the app running.
